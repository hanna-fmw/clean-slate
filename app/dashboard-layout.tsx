...
export function DashboardLayout({
  ...
  return (
    <div className="flex min-h-screen">
      ...
      <div className="flex-1 min-w-0 md:ml-[var(--sidebar-width)] flex flex-col min-h-screen pt-14 md:pt-0">
        <header className="h-14 border-b border-[var(--border)] flex items-center px-4 md:px-6 shrink-0">
